...
# Project:C:\Users\sondree\Desktop\assignment1SimpleProc_new\MIPS_processor\MIPS_processor.xmp
#
...
SYSTEM = MIPS_processor

MHSFILE = MIPS_processor.mhs

MSSFILE = MIPS_processor.mss

FPGA_ARCH = aspartan6

DEVICE = xa6slx16csg324-3
...
SUBMODULE_OPT =  -toplevel no -ti MIPS_processor_i
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/Users/sondree/Desktop/assignment1SimpleProc_new/MIPS_processor/
...
UCF_FILE = data/MIPS_processor.ucf
